package base;
public interface IntBoundaryAndBoundedVsAlu$0 extends base.F$2{
  default Object read$$hash$1(Object p0){
    var this$= this;
    var _aimpl$= (base.Tests$0)p0;
    return ((base.Tests$0)((base.Tests$0)((base.Tests$0)_aimpl$.imm$test$1(
...
((base.Nat$0)base.Int$0Instance.instance(-1L).imm$aluNat$0(
)).read$assertEq$1(
...
base.Int$0Instance.instance(-1L)));
  ...
  IntBoundaryAndBoundedVsAlu$0 instance= new IntBoundaryAndBoundedVsAlu$0(){};}