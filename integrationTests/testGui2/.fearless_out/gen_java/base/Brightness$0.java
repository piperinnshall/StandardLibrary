package base;
public interface Brightness$0 extends base.Wrapper$2, base.DataType$2, base.Extensible$1, base.OrderHash$1, base.Order$1, base.ToImm$1, base.ToInfo$0, base.ToStr$0, base.WidenTo$1{
  default Object read$name$0(){
    var this$= this;
    return base.Str$0Instance.instance("Brightness");
  }
...
new base.LazyInfo$0(){
    ...
    return base.Str$0Instance.instance("Brightness must be between 0 and 1");
  }

}),
new base.Brightness$0(){
  ...
  default Object read$close$1(Object p0){
    var this$= this;
    var _aimpl$= (base.Brightness$0)p0;
    return _aimpl$;
  }
  Brightness$0 instance= new Brightness$0(){};}