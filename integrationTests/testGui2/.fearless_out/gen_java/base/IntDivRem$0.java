package base;
public interface IntDivRem$0 extends base.F$2{
...
((base.Int$0)base.Int$0Instance.instance(-7L).imm$div$1(
base.Nat$0Instance.instance(3L))).read$assertEq$1(
base.Int$0Instance.instance(-2L)))).imm$test$1(
((base.Int$0)base.Int$0Instance.instance(-7L).imm$rem$1(
base.Nat$0Instance.instance(3L))).read$assertEq$1(
...
base.Nat$0Instance.instance(3L))).read$assertEq$1(
base.Int$0Instance.instance(1L)))).imm$test$1(
((base.Opt$1)base.Int$0Instance.instance(6L).imm$divExact$1(
...
base.Int$0Instance.instance(2L))))).imm$test$1(
((base.Opt$1)base.Int$0Instance.instance(7L).imm$divExact$1(
base.Nat$0Instance.instance(3L))).read$assertEq$2(
new base.OrderHashBy$2(){
    public Object imm$$hash$1(Object p0){
...
base.Opt$1.instance));
  ...
  IntDivRem$0 instance= new IntDivRem$0(){};}