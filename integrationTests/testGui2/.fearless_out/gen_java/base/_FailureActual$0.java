...
((base.Str$0)base.Str$0Instance.instance("<actual>").imm$$plus$1(
...
base.Str$0Instance.instance("</actual>")));
  ...
  _FailureActual$0 instance= new _FailureActual$0(){};}